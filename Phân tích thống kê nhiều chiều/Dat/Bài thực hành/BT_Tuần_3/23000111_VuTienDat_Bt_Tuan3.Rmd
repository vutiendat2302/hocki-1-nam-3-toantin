...
# Kiểm tra dist tuân theo phân phối chuẩn,  n > 30 và n <= 50,  shapiro.test(d) kiểm tra xem nó có chuẩn không
?shapiro.test()
shapiro.test(x)
...
# Với mức ý nghĩa 5%, ta chưa thể nói giá trị trung bình của khoảng cách dừng - “dist” lớn hơn 45
